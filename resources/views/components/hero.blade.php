<div class="flex bg-slate-100 rounded-xl">
    <div class="grid grid-cols-3 gap-7 h-screen">
        <div class="col-span-2 ps-[60px] pt-[60px] pb-[40px]">
            <img src="{{ asset('img/logo-biru.png') }}" alt="logo">
            <div class="font-semibold text-2xl my-5">Dokter Hewan Hendrik</div>
            <div class="text-txtgray text-base">
                Perumahan Pakuwon asri, jl.sadewa No.3, Karangtengah Lor, Karangtengah, Kec. Kaliwungu, Kabupaten
                Kendal, Jawa Tengah 51372
            </div>
        </div>
        <div></div>
        <div class="w-full h-full overflow-hidden">
            <img src="{{ asset('img/images-signin.png') }}" class="w-full h-full object-cover" alt="login-img">
        </div>
        <div class="w-full h-full overflow-hidden">
            <img src="{{ asset('img/images-signin.png') }}" class="w-full h-full object-cover" alt="login-img">
        </div class="w-full h-full overflow-hidden">
