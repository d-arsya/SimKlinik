<form class="space-y-3" action="{{ route('api.patient.store') }}" method="post" id="patientForm">
    ...
    <div class="grid items-center w-full grid-cols-[1fr_3fr] gap-4 my-4">
        <label for="" class="text-sm font-medium leading-6 text-gray-700">Nama <span class="text-red-500">*</span></label>
        <input type="type" name="name" class="py-2 pl-3 pr-10 border border-gray-300 rounded-md shadow-sm">
    </div>

    <!-- Gender Patient -->
    <div class="grid items-center w-full grid-cols-[1fr_3fr] gap-4 my-4">
        <label for="" class="text-sm font-medium leading-6 text-gray-700">Gender <span class="text-red-500">*</span></label>
    ...
    <!-- Age Patient -->
    <div class="grid items-center w-full grid-cols-[1fr_3fr] gap-4 my-4">
        <label for="" class="text-sm font-medium leading-6 text-gray-700">Umur <span class="text-red-500">*</span></label>
        <input type="date" name="birth" class="py-2 pl-3 pr-10 border border-gray-300 rounded-md shadow-sm">
    </div>

    <!-- Animal -->
    <div class="grid items-center w-full grid-cols-[1fr_3fr] gap-4 my-4 ">
        <label for="" class="text-sm font-medium leading-6 text-gray-700">Jenis Hewan<span class="text-red-500">*</span></label>
    ...
    <!-- type of Animal -->
    <div class="grid items-center w-full grid-cols-[1fr_3fr] gap-4 my-4 ">
        <label for="" class="text-sm font-medium leading-6 text-gray-700">Ras<span class="text-red-500">*</span></label>
    ...
    <!-- Color -->
    <div class="grid items-center w-full grid-cols-[1fr_3fr] gap-4 my-4 ">
        <label for="" class="text-sm font-medium leading-6 text-gray-700">Warna <span class="text-red-500">*</span></label>
