                ...
                <div class="bg-primary space-y-8 text-white px-7 py-6 rounded-lg w-[452px]">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center border border-white p-4 rounded-lg cursor-pointer h-[45px]">
                                <input value="transfer"
                                    class="form-radio text-white hover:text-[#252F4A] hover:bg-[#252F4A]" name="method"
                                    type="radio" />
                                <span class="ml-4 flex items-center">
                    ...
                    <div>
                        ...
                        <div class="flex justify-between items-baseline">
                            <label>
                                <div>
                                    <input id="discount-check" {{ $invoice->discount ? 'checked' : '' }}
                                        class="form-radio text-black" type="checkbox" />
                                ...
                                <input id="discount-value"
                                    ...
                                    name="discount" placeholder="cth : 30" type="number"
                                    value="{{ $invoice->discount }}" {{ $invoice->discount ? '' : 'disabled' }} />
                            </label>
                            <label>
                                <input class="form-radio text-black" {{ $invoice->free ? 'checked' : '' }} name="free"
                                    id="gratis-pemeriksaan" type="checkbox" />
                                <span class="ml-2 text-[12.43px]">
