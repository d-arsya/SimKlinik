...
@section('container')
    <div class="flex-row px-6 py-3 m-4 border-2 rounded-xl">
        <div class="flex"><b>Tambah User</b></div>
    </div>
    ...
    <form action="{{ route('user.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-4 px-6 py-3 m-4 border-2 rounded-xl">
            ...
            <div class="grid items-center grid-cols-4 gap-4">
                <label for="pulsus" class="text-sm font-medium leading-6 text-gray-700">Role</label>
                <input type="number" id="pulsus" name="pulsus"
                    class="col-span-3 py-2 pl-3 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    required>
            </div>
            <div class="grid items-center grid-cols-4 gap-4">
                <label for="pulsus" class="text-sm font-medium leading-6 text-gray-700">Email</label>
                <input type="number" id="pulsus" name="pulsus"
                    class="col-span-3 py-2 pl-3 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    required>
            </div>
            <div class="grid items-center grid-cols-4 gap-4">
                <label for="pulsus" class="text-sm font-medium leading-6 text-gray-700">Password</label>
                <input type="number" id="pulsus" name="pulsus"
                    class="col-span-3 py-2 pl-3 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    required>
            </div>
            <div class="grid items-center grid-cols-4 gap-4">
                <label for="pulsus" class="text-sm font-medium leading-6 text-gray-700">Konfirmasi Password</label>
                <input type="number" id="pulsus" name="pulsus"
                    class="col-span-3 py-2 pl-3 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                    required>
            </div>
