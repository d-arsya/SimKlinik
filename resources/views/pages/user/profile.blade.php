...
@section('container')
    <div class="text-left">
        ...
        <p class="text-cadet text-[15px]">Dokter Praktek</p>
    </div>
    <div class="mt-4 bg-warning-filter h-[120px] rounded-xl flex items-center justify-center">
        ...
        <span class="text-[80px] font-bold text-warning ms-5 me-2">101</span>
    ...
    <div class="mt-[30px] border-2 rounded-xl">
        <div class="flex justify-between px-[30px] border-b-2">
            ...
            <a href="{{ route('profile.edit') }}"
                class=" text-white px-4 h-[30px] self-center rounded-md inline-flex items-center transition-all duration-200 ease-in-out transform px-2 py-2 mb-2 justify-center text-xs rounded-lg group bg-primary">Edit</a>
        </div>
