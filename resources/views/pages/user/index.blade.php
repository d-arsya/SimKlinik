...
@section('container')
    <div class="flex items-center justify-between">
        <div class="py-5">
            <h2 class="text-xl font-semibold">Tabel User</h2>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('user.create') }}" class="font-bold text-md py-2 px-3 rounded-md text-white bg-primary">Tambah
                User</a>
        ...
        <tbody class="text-gray-700">
            <tr>
                ...
                <td class="px-5 py-4 border flex content-center justify-center gap-x-2  ">
                    <a href="{{ route('user.edit', 1) }}" class="bg-warning p-2 rounded-md">
                    ...
                    <form action="{{ route('user.destroy', 1) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
