...
<!-- Header -->
@section('title', 'Tabel Warna Pasien')
...
@section('table')
    <thead class="border-y border-gray-200 bg-[#FCFCFC]">
        <tr>
            ...
            <th scope="col" class="px-6 py-3 border-r border-gray-200">Kode Warna</th>
            <th scope="col" class="px-6 py-3 border-r border-gray-200">Warna Pasien</th>
