...
<thead class="border-y border-gray-200 bg-[#FCFCFC]">
    <tr>
        ...
        <th scope="col" class="px-6 py-3 border-r border-gray-200">Berat Badan</th>
...
<tbody class="font-medium">
    <tr>
        ...
        <td class="px-6 py-3 border-b border-r border-gray-200">JEN-1</td>
        <td class="px-6 py-3 border-b border-r border-gray-200">Anjing</td>
        <td class="px-6 py-3 border-b border-r border-gray-200">20</td>
        <td class="px-6 py-3 border-b border-r border-gray-200">20C</td>
        <td class="px-6 py-3 border-b border-r border-gray-200">10 rpm</td>
        <td class="px-6 py-3 border-b border-r border-gray-200">20 Kg</td>
        <td class="flex justify-center px-6 py-3 space-x-2 text-center border-b border-gray-200">
            <a href="{{ route('animal.edit',1) }}">
                <x-icons.edit />
            </a>
