...
@section('container')
    <div class="flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="{{ route('animal.create') }}" class="font-bold text-md py-2 px-3 rounded-md text-white bg-primary">Tambah
                Hewan</a>
        ...
        <tbody class="text-gray-700">
            <tr>
                ...
                <td class="px-5 py-4 border flex content-center justify-center gap-x-2  ">
                    <a href="{{ route('animal.edit', 1) }}" class="bg-warning p-2 rounded-md">
                    ...
                    <form action="{{ route('animal.destroy', 1) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
