...
<!-- Header -->
@section('title', 'Tabel Diagnosa Pasien')
...
@section('table')
    <thead class="border-y border-gray-200 bg-[#FCFCFC]">
        <tr>
            ...
            <th scope="col" class="px-6 py-3 border-r border-gray-200">Kode Diagnosa</th>
            <th scope="col" class="px-6 py-3 border-r border-gray-200">Nama Diagnosa</th>
    ...
    <tbody class="font-medium">
        <tr>
            ...
            <td class="px-6 py-3 border-b border-r border-gray-200">ANJ-1</td>
            <td class="px-6 py-3 border-b border-r border-gray-200">Diagnosa 1</td>
