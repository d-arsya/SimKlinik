...
@section('container')
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-8 gap-10">
            ...
            <div>
                ...
                <input type="number" id="jumlah-obat"
                    class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    value="1">
            </div>
            <div class="col-span-3">
                ...
                <textarea id="catatan" rows="10"
                    class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">-- beri note di sini --</textarea>
            </div>
            <button color="blue" type="submit" class="font-medium rounded-lg text-sm px-2 py-3 focus:outline-none">Tambah
                Obat</button>
        </div>
    </div>
        ...
        <table id="dataTable">
            ...
            <tbody class="text-gray-700">
                <tr>
                    ...
                    <td class="px-5 py-4 border">
                        <button type="button" color="red" class="bg-alert hover:bg-hovAlert">
    ...
    <div class="flex place-self-end space-x-2">
        <button color="red" type="submit"
            class="font-medium rounded-lg text-sm px-3 py-3 focus:outline-none">Batal</button>
        <button color="blue" type="submit"
            class="font-medium rounded-lg text-sm px-3 py-3 focus:outline-none">Simpan</button>
    </div>
@endsection
@section('scripts')
