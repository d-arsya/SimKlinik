...
class CheckupFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $drugs = json_encode([["id" => fake()->numberBetween(1, 10), "price" => fake()->numberBetween(1, 100) * 1000, "date" => fake()->date(), "type" => fake()->word(), "name" => fake()->word(4), "amount" => fake()->numberBetween(1, 10), "notes" => fake()->sentence(5)], ["id" => fake()->numberBetween(1, 10), "price" => fake()->numberBetween(1, 100) * 1000, "date" => fake()->date(), "type" => fake()->word(), "name" => fake()->word(4), "amount" => fake()->numberBetween(1, 10), "notes" => fake()->sentence(5)], ["id" => fake()->numberBetween(1, 10), "price" => fake()->numberBetween(1, 100) * 1000, "date" => fake()->date(), "type" => fake()->word(), "name" => fake()->word(4), "amount" => fake()->numberBetween(1, 10), "notes" => fake()->sentence(5)]]);
        return [
